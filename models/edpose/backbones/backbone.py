...
class Joiner(nn.Sequential):
    def __init__(self, backbone, position_embedding):
        ...
        # self.cv1=nn.Conv2d(2048, 256, kernel_size=1)
        # self.cv2=nn.Conv2d(1024, 256, kernel_size=1)
        # self.cv3=nn.Conv2d(512, 256, kernel_size=1)
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        # data[0] =self.cv3(data[0])
        # data[1] =self.cv2(data[1])
        # data[2] =self.cv1(data[2])
        #
